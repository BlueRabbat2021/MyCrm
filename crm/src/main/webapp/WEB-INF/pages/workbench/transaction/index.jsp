...
<script type="text/javascript">
	...
	function queryTranForPageByCondition(pageNo,pageSize){
		// alert("ok");
		var owner = $.trim($("#create_owner").val());
		var name = $.trim($("#create_name").val());
		var customerName = $.trim($("#create_customerName").val());
		var stage = $("#create_stage").val();
		var transactionType = $("#create_transactionType").val();
		var clueSource = $("#create-clueSource").val();
		var contacts = $.trim($("#create_contacts").val());
		$.ajax({
			...
			success:function (data){
				...
				$.each(data.tranList,function (index,obj){
					...
					htmlStr += "<td><a style='text-decoration: none; cursor: pointer;' onclick= window.location.href='workbench/transaction/detailTran.do?id=7667154af9a246dba4e92a53767758a4;'>" + obj.name + "</a></td>";
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="create_owner" type="text">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="create_name" type="text">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="create_customerName" type="text">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control" id="create_stage">
					  	<option></option>
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control" id="create_transactionType">
					  	<option></option>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="create_contacts" type="text">
				    </div>
				  </div>
