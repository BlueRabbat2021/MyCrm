...
$(function () {
	...
	$("#create-accountName").typeahead({
		...
		afterSelect:function (item){ // item就是选中项，补全之后的名字
			$("#create-customerId").val(name2id[item]);
		}
	});
	// 给下拉菜单绑定change事件,只要下拉菜单的内容改变就会触发
	$("#create-transactionStage").change(function (){
		// alert("ok");
		// var stageValue = $("#create-transactionStage option:selected").text(); // 也可以使用下面的方式
